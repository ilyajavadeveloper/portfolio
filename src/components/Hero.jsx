    ...
    >
      <div className="mx-auto flex min-h-[calc(100vh-7rem)] w-full max-w-7xl flex-col items-center justify-center gap-12 px-5 sm:px-6 md:gap-14 lg:grid lg:grid-cols-[0.95fr_1.05fr] lg:gap-12 xl:gap-20 2xl:max-w-[1500px] 2xl:gap-24">
        ...
        <div className="order-2 flex w-full flex-col justify-center lg:order-1">
          ...
          {/* ================= CV DOWNLOADS ================= */}
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:items-start sm:gap-5 xl:gap-6">
            <a
              href="/IT%20CV.pdf"
              download
              className="inline-flex w-full items-center justify-center gap-3 rounded-2xl border border-white/30 bg-white/15 px-8 py-4 text-base font-bold text-white backdrop-blur transition hover:border-white/60 hover:bg-white/25 sm:w-auto lg:px-7 xl:px-9 xl:py-5"
            >
              <Download size={20} />
              IT Resume
            </a>
            ...
            <a
              ...
              download
              className="inline-flex w-full items-center justify-center gap-3 rounded-2xl border border-white/25 bg-white/10 px-8 py-4 text-base font-bold text-white/90 transition hover:border-white/50 hover:bg-white/20 sm:w-auto lg:px-7 xl:px-9 xl:py-5"
            >
              <Download size={20} />
              General Resume
            </a>
